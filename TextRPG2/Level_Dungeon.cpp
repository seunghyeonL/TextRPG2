...
void Level_Dungeon::Render_TextMap()
{
	switch (m_eCurMap)
	{
	case MAP_VILLAGE:
...
void Level_Dungeon::Check_Collision_Potal()
{
	switch (m_eCurMap)
	{
	case MAP_VILLAGE:
...
void Level_Dungeon::Correction_Map_Potal()
{
	switch (m_eCurMap)
	{
	case MAP_VILLAGE:
...
void Level_Dungeon::Push_Space(int i, int j)
{
	switch (m_eCurMap)
	{
	case MAP_VILLAGE:
...
Level_Dungeon* Level_Dungeon::Create()
{
	Level_Dungeon* pInstance = new Level_Dungeon();
